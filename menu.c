...
int volume;
 ...
 musique = Mix_LoadMUS("pnl.mp3");
    ...
    startGame = IMG_Load("playy.png");

    loadGame = IMG_Load("load.png");

    options = IMG_Load("Options.png");

    level = IMG_Load("level.png");

    credit = IMG_Load("credit.png");

    exitGame = IMG_Load("exit.png");



    // Check if loading images failed...
...
Mix_Chunk* soundEffect = Mix_LoadWAV("click1.wav");
                    ...
                    switch (event.button.button) {
                        ...
                        case SDL_BUTTON_LEFT:
                            ...
                            if (gameState == MAIN_MENU) {
                                ...
                                // Check different states and perform actions

                                if (event.motion.x >= 110 && event.motion.x < 645 &&

                                    event.motion.y >= 591 && event.motion.y <= 669) {
...
Mix_PlayChannel(-1, soundEffect, 0);
                                ...
                                } else if (event.motion.x >= 112 && event.motion.x < 635 &&

                                           event.motion.y >= 857 && event.motion.y <= 938) {
...
Mix_PlayChannel(-1, soundEffect, 0);
                                ...
                                } else if (event.motion.x >= 103 && event.motion.x < 651 &&

                                           event.motion.y >= 717 && event.motion.y <= 797 ) {
...
Mix_PlayChannel(-1, soundEffect, 0);
                                ...
                                } else if (event.motion.x >= 101 && event.motion.x < 637 &&

                                           event.motion.y >= 457 && event.motion.y <= 542) {
...
Mix_PlayChannel(-1, soundEffect, 0);
        ...
        switch (gameState) {
            ...
            case MAIN_MENU:
                ...
                if (event.motion.x >= 101 && event.motion.x < 637 &&

                    event.motion.y >= 457 && event.motion.y <= 542) {

                    SDL_BlitSurface(startGame, NULL, screen, &posjdeda);



                } else if (event.motion.x >= 110 && event.motion.x < 645 &&

                           event.motion.y >= 591 && event.motion.y <= 669) {

                    SDL_BlitSurface(loadGame, NULL, screen, &possetting);

                } else if (event.motion.x >= 112 && event.motion.x < 638 &&
                    ...
                    SDL_BlitSurface(credit, NULL, screen, &poscredit);
            ...
            case OPTIONS:
                ...
                if (event.button.button == SDL_BUTTON_LEFT && event.motion.x >= 1763 && event.motion.x < 1873 &&

                           event.motion.y >= 928 && event.motion.y <= 1018) {
...
if (event.button.button == SDL_BUTTON_LEFT && event.motion.x>=179 && event.motion.x<=228 && event.motion.y>=456 && event.motion.y<=484  ){
...
else if (event.button.button == SDL_BUTTON_LEFT && event.motion.x>=893 && event.motion.x<=914 && event.motion.y>=439 && event.motion.y<=460  ){
